...
import { getOrderCanceled } from 'features/User/userSlice';
...
function OrderCancel() {
  const { user: info, orderCanceled: checkout } = useSelector((state) => state.users);
  ...
  useEffect(() => {
    ...
    const handleGetDataPurchase = async () => {
      ...
      tokenExpire === false ? dispatch(getOrderCanceled()) : navigate('/login', { replace: true });
    };
