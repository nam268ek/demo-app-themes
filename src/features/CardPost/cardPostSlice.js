...
export const getAllCardPosts = createAsyncThunk('themes/getAllCardPosts', async () => {
  const data = await themeApi.getCardPostList();
  return data;
});

export const getLimitCardPost = createAsyncThunk('themes/getLimitCardPost', async (params) => {
