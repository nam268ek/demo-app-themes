...
import { DivImage, Image, Content, Title, Desc, StyleLink, Layout } from './Creator.styles';
    ...
    <Container>
      <Layout>
        ...
        <Content>
          ...
          <Desc>
            I have been doing Ghost themes since 2016. I created Aspire Themes to provide simple,
            well-designed, and functional Ghost themes.{' '}
